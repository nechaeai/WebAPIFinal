    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FavoriteMovie>().HasData(
                ...
                new FavoriteMovie { Id = 4, MovieTitle = "To All the Boys I've Loved Before", MovieGenre = "Romance", MovieDirector = "Michael Fimognari", ReleaseDate = new DateTime(2018, 08, 17)}
            );
        }
